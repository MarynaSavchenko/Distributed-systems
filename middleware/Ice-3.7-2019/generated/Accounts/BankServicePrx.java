...
{
    default String createAccount(String firstName, String lastName, String pesel, long monthIncome)
        throws WrongPesel
    {
        return createAccount(firstName, lastName, pesel, monthIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String createAccount(String firstName, String lastName, String pesel, long monthIncome, java.util.Map<String, String> context)
        throws WrongPesel
    {
        try
        {
            return _iceI_createAccountAsync(firstName, lastName, pesel, monthIncome, context, true).waitForResponseOrUserEx();
        }
        catch(WrongPesel ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> createAccountAsync(String firstName, String lastName, String pesel, long monthIncome)
    {
        return _iceI_createAccountAsync(firstName, lastName, pesel, monthIncome, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> createAccountAsync(String firstName, String lastName, String pesel, long monthIncome, java.util.Map<String, String> context)
    {
        return _iceI_createAccountAsync(firstName, lastName, pesel, monthIncome, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_createAccountAsync(String iceP_firstName, String iceP_lastName, String iceP_pesel, long iceP_monthIncome, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     ...
                     ostr.writeLong(iceP_monthIncome);
                 }, istr -> {
                     String ret;
                     ret = istr.readString();
                     return ret;
    ...
    default AccountPrx login(String pesel, String password)
    ...
    default AccountPrx login(String pesel, String password, java.util.Map<String, String> context)
        throws WrongPassword,
               WrongPesel
    {
        try
    ...
    default java.util.concurrent.CompletableFuture<AccountPrx> loginAsync(String pesel, String password)
    {
        return _iceI_loginAsync(pesel, password, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<AccountPrx> loginAsync(String pesel, String password, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<AccountPrx> _iceI_loginAsync(String iceP_pesel, String iceP_password, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<AccountPrx> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "login", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_login);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_pesel);
    ...
    default Credit takeLoan(String currency, double amount, int months, AccountType accountType)
        throws LoanIsNotAllowed
    {
        return takeLoan(currency, amount, months, accountType, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Credit takeLoan(String currency, double amount, int months, AccountType accountType, java.util.Map<String, String> context)
        throws LoanIsNotAllowed
    {
        try
        {
            return _iceI_takeLoanAsync(currency, amount, months, accountType, context, true).waitForResponseOrUserEx();
        }
        catch(LoanIsNotAllowed ex)
        {
            throw ex;
        }
        catch(com.zeroc.Ice.UserException ex)
    ...
    default java.util.concurrent.CompletableFuture<Credit> takeLoanAsync(String currency, double amount, int months, AccountType accountType)
    {
        return _iceI_takeLoanAsync(currency, amount, months, accountType, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Credit> takeLoanAsync(String currency, double amount, int months, AccountType accountType, java.util.Map<String, String> context)
    {
        return _iceI_takeLoanAsync(currency, amount, months, accountType, context, false);
    }
     ...
     * @param iceP_amount -
     * @param iceP_months -
     * @param iceP_accountType -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Credit> _iceI_takeLoanAsync(String iceP_currency, double iceP_amount, int iceP_months, AccountType iceP_accountType, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Credit> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "takeLoan", null, sync, _iceE_takeLoan);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_currency);
                     ostr.writeDouble(iceP_amount);
                     ostr.writeInt(iceP_months);
                     AccountType.ice_write(ostr, iceP_accountType);
                 }, istr -> {
                     final com.zeroc.IceInternal.Holder<Credit> ret = new com.zeroc.IceInternal.Holder<>();
                     istr.readValue(v -> ret.value = v, Credit.class);
